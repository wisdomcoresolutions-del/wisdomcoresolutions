...
function About() {
  return (
    <section className="space-y-20 py-10">
      ...
      {/* Hero */}
      <div className="relative overflow-hidden rounded-[2.5rem] border border-zinc-200 bg-white p-8 md:p-16 shadow-sm">
        <div className="max-w-3xl space-y-6">
          <p className="text-xs uppercase tracking-[0.25em] text-zinc-400 font-bold">Our Story</p>
          <h1 className="text-4xl sm:text-5xl font-extrabold text-zinc-950 leading-tight tracking-tight">
            Built in Sirsa.<br />Engineered for India.
          </h1>
          <p className="text-base text-zinc-600 leading-7">
            WisdomCore Solutions is a precision software engineering company founded by <strong className="text-zinc-900">Anirudh Sharma</strong> in Sirsa, Haryana. We started with a simple but powerful belief — that traditional Indian businesses deserve the same quality of software that large corporations use, built around <em>their</em> workflows, not the other way around.
          </p>
          <p className="text-base text-zinc-600 leading-7">
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-2">
            <Link
              to="/contact"
              className="inline-flex items-center gap-2 rounded-full bg-zinc-950 px-6 py-3 text-xs font-semibold text-white hover:bg-zinc-800 transition shadow-sm"
            >
            ...
            <Link
              to="/case-studies"
              className="inline-flex items-center gap-2 rounded-full border border-zinc-200 bg-white px-6 py-3 text-xs font-semibold text-zinc-800 hover:bg-zinc-50 transition"
            >
              View our work
            </Link>
          </div>
        ...
        {/* Decorative badge */}
        <div className="absolute top-8 right-8 hidden md:flex flex-col items-center justify-center w-28 h-28 rounded-full border border-zinc-200 bg-zinc-50 shadow-sm">
          <span className="text-2xl font-extrabold text-zinc-950">2026</span>
          <span className="text-[10px] text-zinc-500 font-semibold uppercase tracking-wider mt-1">Est.</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
        {STATS.map((stat) => (
          <motion.div
            ...
            className="rounded-[2rem] border border-zinc-200 bg-white p-6 text-center shadow-sm"
          >
            <p className="text-3xl font-extrabold text-zinc-950">{stat.value}</p>
            <p className="mt-1 text-xs text-zinc-500 font-semibold uppercase tracking-wider">{stat.label}</p>
          </motion.div>
        ))}
      </div>

      {/* Founder */}
      <div className="rounded-[2.5rem] border border-zinc-200 bg-white p-8 md:p-12 shadow-sm">
        <div className="grid gap-10 md:grid-cols-[auto_1fr] items-start">
          <div className="flex flex-col items-center gap-3">
            ...
            <div className="text-center">
              <p className="font-bold text-zinc-950 text-sm">Anirudh Sharma</p>
              <p className="text-xs text-zinc-500 font-medium">Founder & Lead Engineer</p>
          ...
          <div className="space-y-4">
            <p className="text-xs uppercase tracking-widest text-zinc-400 font-bold">Meet the Founder</p>
      ...
      {/* Mission */}
      <div className="rounded-[2.5rem] border border-zinc-200 bg-zinc-950 p-8 md:p-14 shadow-sm text-center space-y-4">
        <p className="text-xs uppercase tracking-[0.25em] text-zinc-400 font-bold">Our Mission</p>
        <blockquote className="text-xl md:text-2xl font-bold text-white leading-snug max-w-3xl mx-auto">
      ...
      <div className="space-y-6">
        <div className="space-y-2">
          <p className="text-xs uppercase tracking-[0.25em] text-zinc-400 font-bold">What We Stand For</p>
          <h2 className="text-3xl font-extrabold text-zinc-950 tracking-tight">Our Core Values</h2>
        </div>
        <div className="grid gap-5 md:grid-cols-2">
          {VALUES.map((val, i) => (
            <motion.div
              ...
              className="rounded-[2rem] border border-zinc-200 bg-white p-7 shadow-sm space-y-3"
            >
              <div className="w-8 h-8 rounded-xl bg-zinc-950 flex items-center justify-center">
                <Heart size={14} className="text-white" />
              </div>
              <h3 className="font-bold text-zinc-950 text-base">{val.title}</h3>
              <p className="text-sm text-zinc-600 leading-6">{val.desc}</p>
            </motion.div>
          ))}
        </div>
      </div>
      ...
      <div className="space-y-6">
        <div className="space-y-2">
          <p className="text-xs uppercase tracking-[0.25em] text-zinc-400 font-bold">Domain Expertise</p>
          <h2 className="text-3xl font-extrabold text-zinc-950 tracking-tight">Industries We've Transformed</h2>
        </div>
          ...
          {INDUSTRIES.map((ind, i) => {
            ...
            return (
              <motion.div
                ...
                className="rounded-[2rem] border border-zinc-200 bg-white p-7 shadow-sm space-y-3"
              >
                <div className="w-9 h-9 rounded-xl border border-zinc-200 bg-zinc-50 flex items-center justify-center">
                  <Icon size={17} className="text-zinc-700" />
                </div>
                <h3 className="font-bold text-zinc-950 text-sm">{ind.name}</h3>
                <p className="text-xs text-zinc-600 leading-5">{ind.desc}</p>
              </motion.div>
            )
          })}
        </div>
      ...
      {/* Featured Projects */}
      <div className="rounded-[2.5rem] border border-zinc-200 bg-white p-8 md:p-12 shadow-sm space-y-6">
        <div className="space-y-1">
          <p className="text-xs uppercase tracking-widest text-zinc-400 font-bold">Portfolio Highlights</p>
          <h2 className="text-2xl font-extrabold text-zinc-950 tracking-tight">Projects That Define Us</h2>
        </div>
        <div className="divide-y divide-zinc-100">
          {PROJECTS.map((project) => (
            <div key={project.name} className="flex items-center justify-between py-4 gap-4">
              ...
              <span className="text-[10px] text-zinc-500 font-semibold bg-zinc-50 border border-zinc-200 px-2.5 py-1 rounded-full whitespace-nowrap">
                {project.category}
              </span>
            </div>
          ))}
        ...
        <Link
          to="/case-studies"
          className="inline-flex items-center gap-2 text-xs font-bold text-zinc-950 hover:underline"
        >
      ...
      {/* CTA */}
      <div className="rounded-[2.5rem] border border-zinc-200 bg-white p-8 md:p-14 text-center shadow-sm space-y-5">
        <Zap size={28} className="mx-auto text-zinc-400" />
        <h2 className="text-3xl font-extrabold text-zinc-950 tracking-tight">
          Ready to build something great?
        </h2>
        <p className="text-zinc-600 text-sm max-w-lg mx-auto leading-6">
        ...
        <Link
          to="/contact"
          className="inline-flex items-center gap-2 rounded-full bg-zinc-950 px-8 py-3.5 text-xs font-semibold text-white hover:bg-zinc-800 transition shadow-sm"
        >
